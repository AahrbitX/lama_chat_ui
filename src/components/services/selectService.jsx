...
export default function ChooseService() {
  ...
  return (
    <motion.div
      ...
      className="flex items-center justify-center min-h-screen bg-gradient-to-b from-[#0a0a0a] to-[#111111] text-white px-6 py-20"
    >
      <div className="w-full max-w-3xl absolute top-1/2 transform -translate-y-1/2 rounded-3xl shadow-xl p-10">
        ...
        {!showUpload ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 border border-gray-700 rounded-xl hover:bg-gray-800 transition-all">
              <h3 className="text-xl font-semibold mb-2">Business Chatbot</h3>
              <p className="text-gray-400 mb-4">
                Upload your documents and let our AI-powered assistant take over customer conversations, tailored to your business.
              </p>
              <button
                onClick={handleStartWithBusinessBot}
                className="mt-2 px-4 py-2 bg-indigo-600 rounded-md text-white font-medium hover:bg-indigo-700"
              >
                Start with Business Bot
              </button>
            </div>
            <div className="p-6 border border-gray-700 rounded-xl opacity-60 cursor-not-allowed bg-gray-900">
              <h3 className="text-xl font-semibold mb-2">Website Integrated Chatbot</h3>
              <p className="text-gray-400 mb-4">
                Coming soon: Our AI scans your site and builds a chatbot with no effort required.
              </p>
              <button
