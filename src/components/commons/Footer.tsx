      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between gap-8 md:gap-12 relative z-10">
        ...
        <div className="flex-1 mb-8 md:mb-0 min-w-[220px]">
          ...
          <div className="text-xs text-[#c4b5fd] space-y-1">
            <span className="block">Email: <a href="mailto:support@aahrbitx.com" className="hover:text-[#a78bfa] transition">support@aahrbitx.com</a></span>
            <span className="block">Location: <a href="https://goo.gl/maps/xyz" target="_blank" rel="noopener noreferrer" className="hover:text-[#a78bfa] transition">Kanyakumari, India</a></span>
          </div>
        </div>
        {/* Links */}
        <div className="flex-1 w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3 sm:gap-4 mt-2 flex-wrap">
              <a href="https://www.linkedin.com/company/aahrbitx" target="_blank" rel="noopener noreferrer" className="hover:text-white transition" aria-label="LinkedIn">
              ...
              <a href="https://twitter.com/aahrbitx" target="_blank" rel="noopener noreferrer" className="hover:text-white transition" aria-label="Twitter">
              ...
              <a href="https://github.com/aahrbitx" target="_blank" rel="noopener noreferrer" className="hover:text-white transition" aria-label="GitHub">
              ...
              <a href="https://instagram.com/aahrbitx" target="_blank" rel="noopener noreferrer" className="hover:text-white transition" aria-label="Instagram">
